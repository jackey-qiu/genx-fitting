...
class Slab:
    par_names = ['dx1','dx2','dx3', 'dy1','dy2','dy3', 'dz1','dz2','dz3',
                          'u', 'oc', 'm']
    ...
    def _extract_values(self):
        if self.T_factor=='B':
            return  self.x + self.dx1+self.dx2+self.dx3, self.y + self.dy1+self.dy2+self.dy3, self.z + self.dz1+ self.dz2+ self.dz3,\
