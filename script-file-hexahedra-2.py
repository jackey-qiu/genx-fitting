...
#change from test1, group all Os together for each polyhedra for Oc fitting, and group only the symmetrical
#Os together to consider u fitting, so Os will have the same Oc but only two Os have the same u
#add print data function in sim
####################################################################
...
atm_gp_Pb_domain1,atm_gp_Pb2_domain1,atm_gp_Os_1_domain1,atm_gp_Os_2_domain1,\
    atm_gp_Os_1_0_domain1,atm_gp_Os_1_1_domain1,atm_gp_Os_1_2_domain1,atm_gp_Os_2_0_domain1,atm_gp_Os_2_1_domain1,atm_gp_Os_2_2_domain1=\
    domain_class_1.grouping_discrete_layer_batch(batch_path_head+'group_discrete_layer_file_hexahedra_class1_2.txt')
atm_gp_Pb_domain2,atm_gp_Pb2_domain2,atm_gp_Os_1_domain2,atm_gp_Os_2_domain2,\
    atm_gp_Os_1_0_domain2,atm_gp_Os_1_1_domain2,atm_gp_Os_1_2_domain2,atm_gp_Os_2_0_domain2,atm_gp_Os_2_1_domain2,atm_gp_Os_2_2_domain2=\
    domain_class_2.grouping_discrete_layer_batch(batch_path_head+'group_discrete_layer_file_hexahedra_class2_2.txt')
