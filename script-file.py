...
domain_class_1.add_sorbate_polyhedra(domain=domain1A,polyhedra_flag='tetrahedra',extra_flag=None,extra_flag2=None,attach_atm_id=[['O1_1_0','O1_2_0'],['O1_3_0','O1_4_0']],el='Pb',id_attach=['A','AA'])
domain_class_1.add_sorbate_polyhedra(domain=domain1B,polyhedra_flag='tetrahedra',extra_flag=None,extra_flag2=None,attach_atm_id=[['O1_7_0','O1_8_0'],['O1_9_0','O1_10_0']],el='Pb',id_attach=['B','BB'])
domain_class_2.add_sorbate_polyhedra(domain=domain2A,polyhedra_flag='tetrahedra',extra_flag=None,extra_flag2=None,attach_atm_id=[['O1_5_0','O1_6_0'],['O1_7_0','O1_8_0']],el='Pb',id_attach=['A','AA'])
domain_class_2.add_sorbate_polyhedra(domain=domain2B,polyhedra_flag='tetrahedra',extra_flag=None,extra_flag2=None,attach_atm_id=[['O1_11_0','O1_12_0'],['O1_0','O2_0']],el='Pb',id_attach=['B','BB'])
...
#should be the same
domain_class_1.set_discrete_new_vars_batch(batch_path_head+'new_varial_file_tetrahedra_class1.txt')
domain_class_2.set_discrete_new_vars_batch(batch_path_head+'new_varial_file_tetrahedra_class2.txt')
...
atm_gp_Pb_domain1,atm_gp_Pb2_domain1,atm_gp_Os_1_domain1,atm_gp_Os_2_domain1=domain_class_1.grouping_discrete_layer_batch(batch_path_head+'group_discrete_layer_file_tetrahedra_class1.txt')
atm_gp_Pb_domain2,atm_gp_Pb2_domain2,atm_gp_Os_1_domain2,atm_gp_Os_2_domain2=domain_class_2.grouping_discrete_layer_batch(batch_path_head+'group_discrete_layer_file_tetrahedra_class2.txt')
...
#updata the body center point of each polyhedra
    domain_class_1.updata_polyhedra_center_point_batch(batch_path_head+'polyhedra_center_point_batch_file_class1.txt')
    domain_class_2.updata_polyhedra_center_point_batch(batch_path_head+'polyhedra_center_point_batch_file_class2.txt')
#updata sorbate xyz (bidentate configuration here)
#this part should kept the same
    domain_class_1.updata_sorbate_polyhedra2_batch(batch_path_head+'update_sorbate_tetrahedra_batch_file_class1.txt')
    domain_class_2.updata_sorbate_polyhedra2_batch(batch_path_head+'update_sorbate_tetrahedra_batch_file_class2.txt')
